...
public class MyContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.abhishek.mycontacts.provider";
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)){
            case CONTACTS:
                return "vnd.android.cursor.dir/vnd.com.abhishek.mycontacts.provider.contacts";
            case CONTACTS_ID:
                return "vnd.android.cursor.item/vnd.com.abhishek.mycontacts.provider.contacts";
            default:
