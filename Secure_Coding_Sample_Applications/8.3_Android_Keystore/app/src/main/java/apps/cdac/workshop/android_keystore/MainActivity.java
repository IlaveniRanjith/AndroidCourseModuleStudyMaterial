package apps.cdac.workshop.android_keystore;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String KEY_NAME = "MY KEY";
    ...
    private EditText etInputPlainText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etInputPlainText = findViewById(R.id.et_input_plain_text);
    ...
    private void getKey() {
        try {
            final KeyStore.SecretKeyEntry secretKeyEntry = (KeyStore.SecretKeyEntry) keyStore.getEntry(KEY_NAME, null);
    ...
    public void onEncryptButtonClick(View view) {
        String plainText = etInputPlainText.getText().toString().trim();
        try {
            initKeystore();
            loadOrGenerateKey();
